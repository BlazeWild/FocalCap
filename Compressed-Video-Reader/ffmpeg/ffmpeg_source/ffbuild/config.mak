...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/teamspace/studios/this_studio/.local/cvreader-ffmpeg --bindir=/teamspace/studios/this_studio/.local/bin --enable-pic --disable-doc --disable-debug --disable-ffplay --disable-asm --disable-inline-asm --disable-x86asm
prefix=/teamspace/studios/this_studio/.local/cvreader-ffmpeg
LIBDIR=$(DESTDIR)${prefix}/lib
SHLIBDIR=$(DESTDIR)${prefix}/lib
INCDIR=$(DESTDIR)${prefix}/include
BINDIR=$(DESTDIR)/teamspace/studios/this_studio/.local/bin
...
CC_IDENT=gcc 13 (Ubuntu 13.3.0-6ubuntu2~24.04.1)
ARCH=c
INTRINSICS=none
EXTERN_PREFIX=
CC=gcc
...
CFLAGS=   -std=c11 -fomit-frame-pointer -fPIC    -pthread           -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized -I/usr/include/SDL2 -D_REENTRANT
...
CFLAGS-ffplay=-I/usr/include/SDL2 -D_REENTRANT
...
EXTRALIBS-avcodec=-pthread -lm -latomic -llzma -lz -lva
